...
public final class PingPongServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.abhinav.demo.proto_gen.ping_pong.Request,
      com.abhinav.demo.proto_gen.ping_pong.Response> getPingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ping",
      requestType = com.abhinav.demo.proto_gen.ping_pong.Request.class,
      responseType = com.abhinav.demo.proto_gen.ping_pong.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.abhinav.demo.proto_gen.ping_pong.Request,
      com.abhinav.demo.proto_gen.ping_pong.Response> getPingMethod() {
    io.grpc.MethodDescriptor<com.abhinav.demo.proto_gen.ping_pong.Request, com.abhinav.demo.proto_gen.ping_pong.Response> getPingMethod;
      ...
      synchronized (PingPongServiceGrpc.class) {
        if ((getPingMethod = PingPongServiceGrpc.getPingMethod) == null) {
          PingPongServiceGrpc.getPingMethod = getPingMethod = 
              io.grpc.MethodDescriptor.<com.abhinav.demo.proto_gen.ping_pong.Request, com.abhinav.demo.proto_gen.ping_pong.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "PingPongService", "ping"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.abhinav.demo.proto_gen.ping_pong.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.abhinav.demo.proto_gen.ping_pong.Response.getDefaultInstance()))
  ...
  public static abstract class PingPongServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void ping(com.abhinav.demo.proto_gen.ping_pong.Request request,
        io.grpc.stub.StreamObserver<com.abhinav.demo.proto_gen.ping_pong.Response> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.abhinav.demo.proto_gen.ping_pong.Request,
                com.abhinav.demo.proto_gen.ping_pong.Response>(
                  this, METHODID_PING)))
          .build();
    }
  }
  ...
  public static final class PingPongServiceBlockingStub extends io.grpc.stub.AbstractStub<PingPongServiceBlockingStub> {
    ...
    /**
     */
    public com.abhinav.demo.proto_gen.ping_pong.Response ping(com.abhinav.demo.proto_gen.ping_pong.Request request) {
  ...
  public static final class PingPongServiceFutureStub extends io.grpc.stub.AbstractStub<PingPongServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.abhinav.demo.proto_gen.ping_pong.Response> ping(
        com.abhinav.demo.proto_gen.ping_pong.Request request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PING:
          serviceImpl.ping((com.abhinav.demo.proto_gen.ping_pong.Request) request,
              (io.grpc.stub.StreamObserver<com.abhinav.demo.proto_gen.ping_pong.Response>) responseObserver);
          break;
        default:
  ...
  private static abstract class PingPongServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.abhinav.demo.proto_gen.ping_pong.PingPong.getDescriptor();
    }
